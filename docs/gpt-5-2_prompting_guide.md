...
### [3.1 Controlling verbosity and output shape](#31-controlling-verbosity-and-output-shape)
...
### [3.2 Preventing Scope drift (e.g., UX / design in frontend tasks)](#32-preventing-scope-drift-eg-ux--design-in-frontend-tasks)
...
### [3.3 Long-context and recall](#33-long-context-and-recall)
...
### [3.4 Handling ambiguity & hallucination risk](#34-handling-ambiguity--hallucination-risk)
...
### [Example prompt for a web research agent:](#example-prompt-for-a-web-research-agent)
