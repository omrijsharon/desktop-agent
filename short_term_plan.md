...
- [ ] **Fix the misleading usage text in the docstring**
...
- [ ] **Make ESC emergency stop match the documented behavior**
...
- [ ] **Rename or rework `os_exit()` to be truthful and reliable**
...
- [ ] **Prevent step-mode approval from blocking shutdown indefinitely**
...
- [ ] **Align step-mode protocol with `project.md`**
  - Either:
...
- [ ] **Tighten error responses for easier debugging**
...
- [ ] **Add a Python virtual environment and document it**
